        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    {
                        isLoggedIn ? <Link to='#' className="hover:text-pink-500 transition">My Generation</Link>  :  <Link to='/my-generation' className="hover:text-pink-500 transition">About</Link>
                    }
